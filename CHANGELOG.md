...
### Changed
- **Update variable strings to camelCase**

## [0.6.1] - 2026-03-28

### Changed
- **og3 v0.6.1 Compatibility**: Updated dependency to `og3` v0.6.1.
- **Cross-Platform Support**: Improved build configuration for consistent behavior on `native` platforms.
